...
class StationServiceTest {
    ...
    void test0() throws Exception {
        assertThrows(IllegalArgumentException.class,
            () -> StationValidate.addStationValidate("매봉크"));
    }
    ...
    void test_1() throws Exception {
        assertThrows(IllegalArgumentException.class,
            () -> StationValidate.addStationValidate("크역"));
    }
    ...
    void test() throws Exception {
        assertThrows(IllegalArgumentException.class,
            () -> StationValidate.addStationValidate("매봉역"));
    }
    ...
    void test2() throws Exception {
        assertThrows(IllegalArgumentException.class,
            () -> StationValidate.deleteStationValidate("원투봉역"));
    }
    ...
    void test3() throws Exception {
        assertThrows(IllegalArgumentException.class,
            () -> StationValidate.deleteStationValidate("매봉역"));
    }
    ...
    void test4() throws Exception {
        ...
        assertTrue(StationRepository.stations().stream()
            .anyMatch(station -> station.getName().equals("잠실역")));
    }
    ...
    void test5() throws Exception {
        ...
        assertTrue(StationRepository.stations().stream()
            .noneMatch(station -> station.getName().equals("매봉역")));
    }
    ...
    void test6() throws Exception {
        ...
        assertTrue(StationRepository.stations().stream()
            .noneMatch(station -> station.getName().equals("매봉크역")));
    }
